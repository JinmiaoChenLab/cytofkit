...
<!--
  %\VignetteIndexEntry{SIDAP: run with an example}
  %\VignetteEngine{knitr::knitr}
-->


SIDAP: run with an example
====================================================
...
Dimension reduction is implemented in function `cytof_dimReduction`, methods like `isomap`, `pca`, `lle`, and `tsne` are provided as options. `tsne` is the recommended and default method.
