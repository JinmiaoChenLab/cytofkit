...
<!--
  %\VignetteIndexEntry{SIDAP: workflow of mass cytometry data analysis}
  %\VignetteEngine{knitr::knitr}
-->


SIDAP: workflow of mass cytometry data analysis
====================================================
...
**sidap** provides a user friendly GUI to use **sidap** package. It provides the options for customizing your own analysis.To launch the GUI, just type the command:
```{r}
require("sidap") 
...
![sidap GUI](sidap_GUI.PNG)
               
               
### Run on commands

**sidap** also provides a core function `cytof_tsne_densvm()` to facilitate the analysis pipeline of mass cytometry data. Users only need to define several key parameters to make their analysis automatically. One simple way of running sidap using the core function is like this:
```{r, eval=FALSE}
...
The cluster coordinates, together with the t-SNE, PCA and ISOMAP coordinates, were added to the .FCS files as additional parameters and saved for post analysis, all intermediate files and the plots can be saved using the function `cytof_write_resluts`.
