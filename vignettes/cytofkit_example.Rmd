...
You can also manually launch the Shiny APP with command:
...
PhenoGraph_progression <- cytof_progression(data = data_transformed_1k, cluster = cluster_PhenoGraph, method="isomap", uniformClusterSize = 47, seed = 4)
...
ClusterX_progression <- cytof_progression(data = data_transformed_1k, cluster = cluster_ClusterX, method="isomap", uniformClusterSize = 29, seed = 3)
